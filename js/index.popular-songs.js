class Carousel {
  ...
  initElements() {
    this.container = document.querySelector('.popular-songs__slider');
    this.track = this.container.querySelector('.popular-songs__list');
    this.slides = Array.from(this.track.children);
    this.prevButton = this.container.querySelector(
      '.popular-songs__button.prev'
    );
    this.nextButton = this.container.querySelector(
      '.popular-songs__button.next'
    );
  }
